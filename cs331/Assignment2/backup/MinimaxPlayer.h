...
public:
    ...
    std::vector<OthelloBoard*> Successors(char player, OthelloBoard *b);

    int minimum(int &row, int &col, char player, OthelloBoard *b);
    
    int maximum(int &row, int &col, char player, OthelloBoard *b);
